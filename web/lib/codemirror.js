...
var codemirror_default = {
  autocomplete: dist_exports4,
  closebrackets: dist_exports5,
  commands: dist_exports7,
  comment: dist_exports8,
  highlight: dist_exports9,
  language: dist_exports3,
  matchbrackets: dist_exports6,
  state: dist_exports,
  view: dist_exports2
};
export {
